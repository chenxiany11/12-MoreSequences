...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  7 brown dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 125)
    draw_points_on_circle(window, circle, 30, 'brown')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'PIZZA test 4:  10 slices, thin (thickness=4) red lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 100)
    circle.outline_thickness = 3
    pizza(window, circle, 10, 'red', 5)
    window.close_on_mouse_click()
...
def pizza(window, circle, number_of_slices, color, thickness):
    ...
    # ------------------------------------------------------------------
    circle.attach_to(window)
    start_pt = circle.center
    end_pt = generate_points_on_circle(circle, number_of_slices)
    for k in range(number_of_slices):
        line = rg.Line(start_pt, end_pt[k])
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'POLYGON tests 3:  10 segments with thick green lines.'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    polygon(window, circle, 10, 'green', 5)
    window.close_on_mouse_click()
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    line = rg.Line(point[number_of_segments-1], point[0])
    line.color = color
    line.thickness = thickness
    line.attach_to(window)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  50 red lines on yellow circle, hops = 10.'
    window = rg.RoseWindow(480, 400, title)

    circle = rg.Circle(rg.Point(200, 165), 100)
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 50, 10, 'red', 5)
    window.close_on_mouse_click()
