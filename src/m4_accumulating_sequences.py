...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        left_p = rg.Point(center.x-radii, center.y-radii)
        right_p = rg.Point(center.x+radii, center.y+radii)
        rectangle = rg.Rectangle(left_p, right_p)
        list_rec = list_rec + [rectangle]
    return list_rec
